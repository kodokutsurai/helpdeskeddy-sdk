import { ApiDataResponse, DictionaryItem, Note, User } from "../types/api-response.type";
import { NoteCreatePayload, UserCreatePayload, UserUpdatePayload } from "../types/api-payload.type";
...
export declare class UsersResource extends BaseResource {
    ...
    deleteById(userId: number): Promise<import("../types/api-response.type").ApiErrorResponse>;
    /**
    ...
    deleteNote(userId: number, noteId: number): Promise<import("../types/api-response.type").ApiErrorResponse>;
}
